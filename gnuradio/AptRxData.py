...
class AptRxData(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Receptor APT NOAA", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "AptRxData")
        ...
        self._delay_range = qtgui.Range(0, 5, 1, 0, 200)
        ...
        self._af_gain_range = qtgui.Range(0, 3, .1, 1.5, 100)
        self._af_gain_win = qtgui.RangeWidget(self._af_gain_range, self.set_af_gain, "Volumen audio", "dial", float, QtCore.Qt.Horizontal)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.hilbert_fc_0 = filter.hilbert_fc(5, window.WIN_HAMMING, 6.76)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/hagit/Downloads/2019.01.05.16.36.27(1).dat', False, 0, 0)
